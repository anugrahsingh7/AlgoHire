          ...
          <div className="text-white lg:w-1/2 lg:mx-6">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              ...
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2 text-white truncate w-72">Cecilia Chapman 711-2880 Nulla St. Mankato Mississippi 96522</span>
              </p>
            ...
            <div className="mt-6 md:mt-8">
              ...
              <div className="flex mt-4 -mx-1.5">
                {["#", "#", "#", "#"].map((link, index) => (
                  <a key={index} className="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500" href={link}>
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
              ...
              <form className="mt-4">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                >
                  Send message
                </button>
              </form>
